        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <nav className="flex justify-between items-center px-8 py-4 bg-white border-b border-gray-200">
            ...
            {/* <div className="flex-1 flex justify-center items-center gap-2">
              <span className="font-inter font-semibold text-gray-500 text-sm">Run</span>
              <span className="border-l border-gray-300 h-4 mx-2"></span>
              <span className="font-inter font-semibold text-gray-500 text-sm">Board</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="font-inter font-semibold text-gray-500 text-sm">Knowledge</span>
            </div> */}
          </nav>
